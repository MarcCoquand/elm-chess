...
var author$project$Example$suite = A2(
	...
	_List_fromArray(
		[
			...
			function (_n0) {
				return A2(elm_explorations$test$Expect$equal, true, false);
			})
		]));
...
var author$project$Square$IsPiece = F2(
	function (a, b) {
		return {$: 'IsPiece', a: a, b: b};
	});
var author$project$Square$initialBoard = function () {
	var wRo = A2(
		author$project$Square$IsPiece,
		author$project$Player$White,
		author$project$Piece$Rook(false));
	var wQu = A2(author$project$Square$IsPiece, author$project$Player$White, author$project$Piece$Queen);
	var wPa = A2(
		author$project$Square$IsPiece,
		author$project$Player$White,
		author$project$Piece$Pawn(false));
	var wKn = A2(author$project$Square$IsPiece, author$project$Player$White, author$project$Piece$Knight);
	var wKi = A2(
		author$project$Square$IsPiece,
		author$project$Player$White,
		author$project$Piece$King(false));
	var wBi = A2(author$project$Square$IsPiece, author$project$Player$White, author$project$Piece$Bishop);
	var bla = author$project$Square$Blank;
	var bRo = A2(
		author$project$Square$IsPiece,
		author$project$Player$Black,
		author$project$Piece$Rook(false));
	var bQu = A2(author$project$Square$IsPiece, author$project$Player$Black, author$project$Piece$Queen);
	var bPa = A2(
		author$project$Square$IsPiece,
		author$project$Player$Black,
		author$project$Piece$Pawn(false));
	var bKn = A2(author$project$Square$IsPiece, author$project$Player$Black, author$project$Piece$Knight);
	var bKi = A2(
		author$project$Square$IsPiece,
		author$project$Player$Black,
		author$project$Piece$King(false));
	var bBi = A2(author$project$Square$IsPiece, author$project$Player$Black, author$project$Piece$Bishop);
...
var author$project$Test$Generated$Main4008692521$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/marccoquand/Projects/chessElm/tests/Example.elm', '/home/marccoquand/Projects/chessElm/tests/SquareTest.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 388579769533119
	},
...
_Platform_export({'Test':{'Generated':{'Main4008692521':{'init':author$project$Test$Generated$Main4008692521$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-11710.sock";
